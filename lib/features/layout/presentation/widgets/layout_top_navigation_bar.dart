              ...
              child: DefaultTabController(
                ...
                child: TabBar(
                  ...
                  tabs: [
                    CustomTabs(
                      title: 'Home',
                      index: cubit.currentNavigationBarIndex,
                      tabIndex: 0,
                      iconData: FontAwesomeIcons.house,
                      solidIconData: FontAwesomeIcons.house,
                    ),
                    CustomTabs(
                      title: 'Favourite',
                      index: cubit.currentNavigationBarIndex,
                      ...
                      solidIconData: FontAwesomeIcons.solidHeart,
                    ),
                    CustomTabs(
                      title: 'Cart',
                      index: cubit.currentNavigationBarIndex,
                      ...
                      solidIconData: FontAwesomeIcons.opencart,
                    ),
                    CustomTabs(
                      title: 'Account',
                      index: cubit.currentNavigationBarIndex,
                      ...
                      solidIconData: FontAwesomeIcons.solidUser,
                    ),
                  ],
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Row(
        ...
        children: [
          FaIcon(
            index == tabIndex ? solidIconData : iconData,
            size: index == tabIndex ? 19 : 19,
